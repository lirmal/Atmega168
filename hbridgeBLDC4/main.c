...
int main(void)
{
	...
	while (1)
	{
		...
		{
			case 1:
			H1=abs(AMPLITUDE*sin(2*PI*discreteTime/(6.0*countTo)));
			L1=0;
			H2=0;
			L2=abs(AMPLITUDE*sin(2*PI*(discreteTime/(6.0*countTo)-1.0/3.0)));
			H3=abs(AMPLITUDE*sin(2*PI*(discreteTime/(6.0*countTo)-2.0/3.0)));
			L3=0;
			break;
			...
			L2=abs(AMPLITUDE*sin(2*PI*(discreteTime/(6.0*countTo)-1.0/3.0)));
			H3=0;
			L3=abs(AMPLITUDE*sin(2*PI*(discreteTime/(6.0*countTo)-2.0/3.0)));
			break;
			
			case 3:
			H1=abs(AMPLITUDE*sin(2*PI*discreteTime/(6.0*countTo)));
			L1=0;
			H2=abs(AMPLITUDE*sin(2*PI*(discreteTime/(6.0*countTo)-1.0/3.0)));
			L2=0;
			H3=0;
			L3=abs(AMPLITUDE*sin(2*PI*(discreteTime/(6.0*countTo)-2.0/3.0)));
			break;
			...
			case 4:
			H1=0;
			L1=abs(AMPLITUDE*sin(2*PI*discreteTime/(6.0*countTo)));
			H2=abs(AMPLITUDE*sin(2*PI*(discreteTime/(6.0*countTo)-1.0/3.0)));
			L2=0;
			H3=0;
			L3=abs(AMPLITUDE*sin(2*PI*(discreteTime/(6.0*countTo)-2.0/3.0)));
